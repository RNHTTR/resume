...
var HTMLskillsStart = '<h3 id="skills-h3">Skills</h3><hr id="skills-hr"><ul id="skills" class="flex-row"></ul>';
...
// var HTMLschoolLocation = '<div class="location-text">%data%</div><hr>';
